    ...
    bio: (
      <>
        <p>
          ...
          Basically, if it’s nerdy, I’m into it.I also love games, and my ultimate career goal is to become a game
          developer.
        </p>
        <p>
    ...
    bio: (
      <>
        <p>
          ...
          communicates our ideas and concepts.
        </p>
        <p>
          ...
          collaborated with Mahin to integrate content seamlessly with the
